...
CREATE TABLE Voiture (
    ...
    energie ENUM('Essence', 'Diesel', 'Électrique', 'Hybride'),
    couleur VARCHAR(30),
...
CREATE TABLE Covoiturage (
    ...
    statut ENUM('En attente', 'En cours', 'Annulé', 'Terminé') DEFAULT 'En attente',
    nb_places INT,
    prix_personne FLOAT,
    voiture_id INT,
...
CREATE TABLE Utilisateur_Covoiturage (
    ...
    statut ENUM('En cours', 'Annulé', 'Terminé') DEFAULT 'En cours',
...
CREATE TABLE Paiement (
    ...
    avancement ENUM('Effectué', 'Annulé', 'En attente') DEFAULT 'En attente',
...
CREATE TABLE Suspension (
    ...
    date_fin DATETIME,
    sanction ENUM('Actif', 'Désactivé') DEFAULT 'Actif',
